...
public class CustomerController {
     ...
     * @param fullname - Задаётся имя пользователя в дополнение к логину
     * @param login - логин пользователя
     * @param email - e-mail для пользователя
     * @param role - задаём роль пользователя
     * @return
     */
    @PostMapping ("/new")
